...
from backend.core.auth import get_authenticated_user, get_current_user
from backend.core.config import cors_origin_regex, cors_origins
from backend.services.chat import ChatMessage, ChatSession, chat_service

app = FastAPI(title="ShopMate Chat API", version="0.1.0")
