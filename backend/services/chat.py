...
from backend.repositories.agent_state_codec import (
    deserialize_agent_state,
    parse_timestamp,
    serialize_agent_state,
)
from backend.repositories import chat_store
from backend.repositories.chat_store import ChatStoreError
from backend.services.conversation_summary import prepare_conversation_context

_STREAM_STATUS_BY_NODE = {
    "planner_node": "กำลังวางแผนและเลือกแหล่งข้อมูล...",
    "prepare_reasoning_node": "กำลังเตรียม Reasoning and Action...",
    "reasoning_action_node": "กำลังวิเคราะห์และเลือกใช้เครื่องมือ...",
    "tools_node": "กำลังค้นหาข้อมูล / เรียก tools...",
    "synthesizer_node": "กำลังสรุปและตรวจสอบคำตอบ...",
}
_USER_ANSWER_STREAM_NODES = frozenset({"synthesizer_node"})
